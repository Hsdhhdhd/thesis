...
- 用柱状图显示 LR, SVM, DT, RF, KNN 的 F1：
  ...
  - RF 0.911
  - KNN 0.957
- 旁边放 `images/ch6_person5_confusion_matrix_best_f1.png`
...
KNN achieved the best F1-score on the held-out participant, with F1 equal to 0.957. Out of 165 pelvic-rotation windows, it correctly detected 155 and missed 10. Out of 3,497 static-sitting windows, only 4 were misclassified as pelvic rotation.
