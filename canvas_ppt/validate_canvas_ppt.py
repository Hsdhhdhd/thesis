#!/usr/bin/env python3
"""Validate the 5.17 Canvas PPT without needing a browser.

Checks:
- index.html is parseable HTML.
- the inline JavaScript has valid syntax when Node.js is available.
- the deck contains the expected 28 slide definitions.
- every image referenced through the 5.17 asset folders exists.
"""
...
INDEX = REPO_ROOT / "canvas_ppt" / "index.html"
EXPECTED_SLIDES = 28
ASSET_BASES = {
    "A": REPO_ROOT / "5.17ppt整理" / "02_图片素材" / "实际PPT已用图片",
    "G": REPO_ROOT / "5.17ppt整理" / "02_图片素材" / "生成图片_image2_可选",
}
...
if __name__ == "__main__":
    ...
    except Exception as exc:  # noqa: BLE001 - validation script should print a concise failure.
